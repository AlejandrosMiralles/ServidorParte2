 ...
 */
final class Version20221014112741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
         $this->addSql('ALTER TABLE contacto ADD COLUMN nombre vartext , ADD COLUMN telefono vartext , ADD COLUMN email vartext');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacto ADD nombre VARCHAR(255) NOT NULL, ADD telefono VARCHAR(15) NOT NULL, ADD email VARCHAR(255) NOT NULL');
    }
}
